...
class PurchaseOrder(models.Model):
    ...
    approval_request_id = fields.Many2one('approval.request', string="Aprobación", readonly=True, store=True, copy=False)
    approval_status = fields.Selection([
        ('new', 'To Submit'),
        ('pending', 'Submitted'),
        ('approved', 'Approved'),
        ('refused', 'Rejected'),
        ('cancel', 'Cancel')], related="approval_request_id.request_status", string="Estado de la Aprobación")
